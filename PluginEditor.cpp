...
void MidSideAudioProcessorEditor::paint (juce::Graphics& g)
{
    ...
    g.setFont (15.0f);
    g.drawFittedText ("Mid Side Gain", 100, 0, getWidth(), 30, juce::Justification::centred, 1);
}
...
void MidSideAudioProcessorEditor::resized()
{
    ...
    midLabel.setBounds (50, 580, getWidth(), 20);
    sideLabel.setBounds (100, 580, getWidth(), 20);
}
